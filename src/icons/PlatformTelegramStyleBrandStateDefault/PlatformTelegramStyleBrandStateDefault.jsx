...
export const PlatformTelegramStyleBrandStateDefault = ({ className }) => {
  return (
    <svg
      className={`platform-telegram-style-brand-state-default ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
    ...
    >
      <g className="g" clipPath="url(#clip0_2_8484)">
        <path
          className="path"
          d="M12 24C18.6274 24 24 18.6274 24 12C24 5.37258 18.6274 0 12 0C5.37258 0 0 5.37258 0 12C0 18.6274 5.37258 24 12 24Z"
          fill="url(#paint0_linear_2_8484)"
        />
        <path
          className="path"
          clipRule="evenodd"
      ...
      <defs className="defs">
        ...
        <clipPath className="clip-path" id="clip0_2_8484">
